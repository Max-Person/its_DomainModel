...
class QuestionNode (
    ...
    internal constructor(el : Element) : this(
        ...
        Operator.build(el.getSingleByWrapper("Expression").nullCheck("QuestionNode has to have an 'Expression' child tag")),
        ...
        el.getChild("Triviality")?.let { Operator.build(it.getChild().nullCheck("Triviality must contain a valid expression XML")) },
    ){
